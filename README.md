...
* Authorization is enforced so that:
     1. Users may only view recipes that are their own or public.
     2. Users may only change recipes that are their own
     3. User may only delete recipes that are their own.
* Admin users may:
